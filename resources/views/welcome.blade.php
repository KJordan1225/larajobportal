...
<head>
    ...
    <!-- CSS here -->
    <link rel="stylesheet" href="{{ asset('assets/new_css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/new_css/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/new_css/magnific-popup.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/new_css/font-awesome.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/new_css/themify-icons.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/new_css/nice-select.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/new_css/flaticon.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/new_css/gijgo.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/new_css/animate.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/new_css/slicknav.css') }}">

    <link rel="stylesheet" href="{{ asset('assets/new_css/style.css') }}">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-6">
                        <div class="slider_text">
                            <h5 class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".2s">{{ $totaljobs }} Jobs listed</h5>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="section_title">
                        <h3>Top Job Listings</h3>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="brouse_job text-right">
                        <a href="jobs.html" class="boxed-btn4">Browse More Jobs</a>
                    </div>
                </div>
            </div>
            <div class="job_lists">
