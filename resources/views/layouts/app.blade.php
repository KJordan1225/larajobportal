...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/job-listing.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/bootstrap.min.css') }}">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto nav navbar-nav-first">
                        <!-- Authentication Links -->

                        <li class="active"><a class="nav-link fs-4" href="/">Home</a></li>
                         <li><a class="nav-link fs-4" href="#">Browse Jobs</a></li>
                         <li><a class="nav-link fs-4" href="#">Pages</a></li>
                         <!-- <li><a class="nav-link fs-4" href="#">Authors</a></li> -->
                         <li><a class="nav-link fs-4" href="#">Contact Us</a></li>
